...
class LidarNode(Node):
    ...
    def load_bagfile(self, bagfile_path):
        with open(bagfile_path.replace('.bag', '_metadata.yaml'), 'r') as stream:
            try:
...
#             self.objsSize.append(size)
#
#         self.bagfile_path = '/Users/kimgyeong-yeon/PycharmProjects/pythonProject/purdue/3D/LidarObjectDetection_2D/Bag_Test/rosbag2_2024_02_12-16_32_41_0.db3'
#         self.load_bagfile(self.bagfile_path)
#
#         self.mytimer = QTimer()
#         self.mytimer.start(10)
...
#
#     def load_bagfile(self, bagfile_path):
#         with open(bagfile_path.replace('.db3', '_metadata.yaml'), 'r') as stream:
#             try:
#                 metadata = yaml.safe_load(stream)
#                 self.point_cloud_topic = metadata['topics_with_message_count']
#             except yaml.YAMLError as exc:
#                 print(exc)
#
#     def point_cloud_callback(self, msg):
